      ...
      <Grid size={{xs: 0, sm: 0, md: 3, lg: 3, xl: 2}} sx={{backgroundColor: grey[900]}}>
        <Box sx={{justifyContent: "center", textAlign: "center", mt: 2}}>
          ...
          <Tabs orientation="vertical" variant="scrollable" scrollButton="auto" allowScrollButtonsMobile>
            <Tab label="خانه" icon={<HomeRounded />} iconPosition="start"></Tab>
            <Tab label="درباره من" icon={<FaceRounded />} iconPosition="start"></Tab>
            <Tab label="رزومه من" icon={<TextSnippetRounded />} iconPosition="start"></Tab>
            <Tab label="نمونه کارها" icon={<TerminalRounded />} iconPosition="start"></Tab>
            <Tab label="ارتباط با من" icon={<ConnectWithoutContactRounded />} iconPosition="start"></Tab>
          </Tabs>
          <Divider variant="middle" color={grey[900]}/>
